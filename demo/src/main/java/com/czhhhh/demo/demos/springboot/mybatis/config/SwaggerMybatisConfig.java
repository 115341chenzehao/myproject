package com.czhhhh.demo.demos.springboot.mybatis.config;
...
public class SwaggerMybatisConfig {
    @Bean(name = "MyBatisDocket")
    public Docket docket() {
        Docket docket = new Docket(DocumentationType.OAS_30) //swagger的版本
                .apiInfo(apiInfo2()).enable(true) //返回apiInfo的配置
                .groupName("Mybatis") //多个Swagger时，需要配置组名
                .select()
                // apis指定启用swagger接口---的包路径
                .apis(RequestHandlerSelectors.basePackage("com.czhhhh.demo.demos.springboot.mybatis.controller"))
     ...
     * @return
     */
    @Bean(value = "springfoxHandlerProviderBeanPostProcessor02")
